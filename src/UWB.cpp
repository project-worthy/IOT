...
int antena_delay_index = 0;
int antena_delay_receive[3] = {0};
int antena_delay_self;

double distances[3] = {0};
double this_anchor_target_distance = 0;
...
void uwb_loop() {
    // dwt_setrxantennadelay(antena_delay_self);
    // dwt_settxantennadelay(antena_delay_self);
    dwt_setrxantennadelay(16500);
    dwt_settxantennadelay(16500);
